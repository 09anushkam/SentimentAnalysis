...
Original file is located at
    https://colab.research.google.com/drive/1pucgxRuxbM3e_mVC4hn6Yqg1fZys9KET
"""
...
sia.polarity_scores('I hate you but I like your good quality')
...
for i,row in tqdm(df.iterrows(),total=len(df)):
  try:
    text=row['Text']
    myid=row['Id']
    vander_result=sia.polarity_scores(text)
    vader_result_rename={}
...
# Compare the scores of vander and Roberts
result_df.columns
